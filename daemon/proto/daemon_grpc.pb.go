...
type DaemonClient interface {
	...
	GetsolvedChallenges(ctx context.Context, in *GetsolvedChallengesReq, opts ...grpc.CallOption) (*GetsolvedChallengesResp, error)
}
...
func (c *daemonClient) GetsolvedChallenges(ctx context.Context, in *GetsolvedChallengesReq, opts ...grpc.CallOption) (*GetsolvedChallengesResp, error) {
	out := new(GetsolvedChallengesResp)
	err := c.cc.Invoke(ctx, "/daemon.Daemon/GetsolvedChallenges", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DaemonServer interface {
	...
	GetsolvedChallenges(context.Context, *GetsolvedChallengesReq) (*GetsolvedChallengesResp, error)
...
func (UnimplementedDaemonServer) GetsolvedChallenges(context.Context, *GetsolvedChallengesReq) (*GetsolvedChallengesResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetsolvedChallenges not implemented")
}
...
func _Daemon_GetsolvedChallenges_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetsolvedChallengesReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonServer).GetsolvedChallenges(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/daemon.Daemon/GetsolvedChallenges",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonServer).GetsolvedChallenges(ctx, req.(*GetsolvedChallengesReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Daemon_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetsolvedChallenges",
			Handler:    _Daemon_GetsolvedChallenges_Handler,
		},
	},
