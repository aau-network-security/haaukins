...
type Host interface {
	...
	UpdateEventFile(store.EventConfig) error
...
func (eh *eventHost) UpdateEventFile(eventConfig store.EventConfig) error {
	if err := eh.efh.UpdateEventFile(eventConfig); err!=nil{
		return err
	}
	return nil
}
